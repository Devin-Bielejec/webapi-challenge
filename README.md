...
- `get()`: calling get returns an array of alleeeee the resources contained in the database. If you pass an `id` to this method it will return the resource with that id if one is found.
